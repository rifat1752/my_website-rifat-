      ...
      >
        <div className="flex  flex-row justify-between items-center">
          ...
          <div className="float-right p-2 md:hidden " onClick={Clicked}>
            {open === true ? (
              <FaWindowClose className=" text-4xl  cursor-pointer " />
            ) : (
              <IoMdMenu className="text-4xl text-yellow-400 cursor-pointer " />
            )}
          </div>
        </div>
        <div
          className={`w-full md:w-auto   pb-2 justify-center  items-center  flex flex-col md:flex-row     md:transparent rounded  bg-opacity-80 md:bg-opacity-0  absolute md:static ${
