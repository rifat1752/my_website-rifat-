...
const Banner = () => {
  const [isComplete, setIsComplete] = useState(false);
    ...
    return (
        <div style={{ borderColor: 'rgb(30 41 59)', borderWidth: '2px' }} className="relative overflow-hidden w-full pb-10 min-h-screen  grid grid-cols-6 bg-base-200 rounded-b-2xl">
      ...
      >
            ...
            <div
              className=" z-10 flex flex-col sm:ml-5 justify-around px-5 gap-5  col-span-6   md:col-span-3 ">
               <div
               className="pt-5 lg:w-3/4      flex flex-col gap-5    mx-auto  details ">
                <p  className="z-10 w-28 mx-auto "><Lottie animationData={animation2} loop={true}> </Lottie></p>
               ...
               <div 
               className="hidden md:flex md:w-3/4    gap-2 flex-col md:flex-row flex-wrap md:mx-auto items-center  justify-center lg:justify-start    ">
                <ContactInfo Banner={true} ></ContactInfo>
                <Link className=""><button className="w-32 h-10 lg:ml-[-10px]  xl:ml-0 md:mr-6 mt-2 ml-2 md:mt-0 font-semibold hover:text-black transition-all duration-500  text-yellow-400 border hover:bg-yellow-400 border-yellow-400  rounded-md ">Download CV</button></Link>
               </div>
            </div>
            <div
             data-aos="fade-left"
             ...
             className="image z-10 my-5 mx-auto flex items-end col-span-6   md:col-span-3 w-full h-full ">
                <figure className="w-3/4  m-auto">
                  <Lottie className="block w-full sm:w-2/3 md:w-full mx-auto" animationData={animation1} > </Lottie>
                </figure>
