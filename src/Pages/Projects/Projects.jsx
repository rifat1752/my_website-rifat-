...
const Projects = () => {
    ...
    <div>
      ...
      data-aos-duration="500"  className="w-full h-full backdrop-blur-sm flex gap-5 flex-col justify-center items-center">
        <p   className="font-bold    text-yellow-400 text-center text-5xl">Projects I've made</p>
