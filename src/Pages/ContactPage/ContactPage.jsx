...
const ContactPage = () => {
    return (
      ...
      data-aos-duration="500"   className="w-full h-full backdrop-blur-sm flex  flex-col gap-2 2xl:gap-10 justify-center items-center">
        <p    className="font-bold    text-yellow-400 text-center text-5xl 2xl:text-8xl">Get in Touch</p>
